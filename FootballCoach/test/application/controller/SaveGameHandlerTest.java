...
public class SaveGameHandlerTest {
    ...
    /**
     * Tests if the loadCompetition method throws an exception when an invalid
     * id is entered
     *
    ...
    /**
     * Test if an error is correctly thrown if we try to call getDateById with
     * an invalid savegame id
     *
