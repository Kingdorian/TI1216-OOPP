...
public class PlayerTest {
	...
	public void testToString(){
		assertEquals("Player [attack=90, defence=60, stamina=80Players [name=Bob, surname=De Bouwer, number=9, status=DEFAULT, timeNotAvailable=5, reason=DEFAULT]]", player1.toString());
	}
