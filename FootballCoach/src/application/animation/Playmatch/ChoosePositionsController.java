...
import application.animation.ContainerPackage.TeamPositions;
...
public class ChoosePositionsController {
    ...
    public static void makeDragable(Circle circle) {
        ...
        circle.setOnMousePressed((MouseEvent mouseEvent) -> {
            ...
            thisController.getSelectPlayerBox().setItems(FXCollections.observableArrayList(fieldPlayerList));
    ...
    public static void setKeeperEvents(Circle circle) {
        ...
        circle.setOnMousePressed(e -> {
            ...
            //set the selection list items to field players
            thisController.getSelectPlayerBox().setItems(FXCollections.observableArrayList(keeperList));
    ...
    public void drawCircles(Stage stage, AnchorPane anchorPane, Team team) {
        ...
        playerCircle[10] = new Circle(60, 381, 13, Color.BLUE); // keeper circle which shouldn't be dragable
        ...
        playerCircle[0].addEventHandler(MouseEvent.ANY, new CircleDragHandler(playerCircle[0], false));
        ...
        playerCircle[10].addEventHandler(MouseEvent.ANY, new CircleDragHandler(playerCircle[10], true));
