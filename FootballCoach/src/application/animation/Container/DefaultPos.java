...
public enum DefaultPos {
    ...
    L0(new Circle(60, 381, 13, Color.BLUE), new Position(60, 381)),
    L1(new Circle(330, 160, 13, Color.BLUE), new Position(330, 160)),
    L2(new Circle(288, 290, 13, Color.BLUE), new Position(288, 290)),
    L3(new Circle(288, 467, 13, Color.BLUE), new Position(288, 467)),
    L4(new Circle(330, 605, 13, Color.BLUE), new Position(330, 605)),
    L5(new Circle(550, 250, 13, Color.BLUE), new Position(550, 250)),
    L6(new Circle(450, 385, 13, Color.BLUE), new Position(450, 385)),
    L7(new Circle(550, 513, 13, Color.BLUE), new Position(550, 513)),
    L8(new Circle(713, 259, 13, Color.BLUE), new Position(713, 259)),
    L9(new Circle(785, 385, 13, Color.BLUE), new Position(785, 385)),
    L10(new Circle(719, 494, 13, Color.BLUE), new Position(719, 494)),
    R0(new Circle(963, 381, 13, Color.RED), new Position(963, 381)),
    R1(new Circle(700, 160, 13, Color.RED), new Position(700, 160)),
    R2(new Circle(730, 290, 13, Color.RED), new Position(730, 290)),
    R3(new Circle(730, 467, 13, Color.RED), new Position(730, 467)),
    R4(new Circle(700, 605, 13, Color.RED), new Position(700, 605)),
    R5(new Circle(461, 250, 13, Color.RED), new Position(461, 250)),
    R6(new Circle(562, 385, 13, Color.RED), new Position(562, 385)),
    R7(new Circle(461, 513, 13, Color.RED), new Position(461, 513)),
    R8(new Circle(306, 259, 13, Color.RED), new Position(306, 259)),
    R9(new Circle(233, 385, 13, Color.RED), new Position(233, 385)),
    R10(new Circle(306, 494, 13, Color.RED), new Position(306, 494));
