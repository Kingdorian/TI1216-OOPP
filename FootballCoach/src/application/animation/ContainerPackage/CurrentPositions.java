...
/**
 * Store the positions of the players way more precise than a
 * PositionsTimeSlice, so it's easier to do calculations with them, but it also
 * takes more space, so for storing multiple sets of positions you should use a
 * PositionsTimeSlice.
 *
 * @author faris
 */
public class CurrentPositions {
    ...
    /**
     * Convert the positions saved in this class to a positions time slice. A
     * position time slice stores the positions way more efficient, but less
     * precise.
     *
     * @return
     */
