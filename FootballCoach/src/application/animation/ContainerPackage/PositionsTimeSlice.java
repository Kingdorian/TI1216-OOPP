...
/**
 * Container class containing 24 player positions (Player objects), creating the
 * positions for all players of a football game at a point in time. A player
 * object is null if the player isn't on the field for any reason.
 *
 * @author faris
 */
public class PositionsTimeSlice {
    ...
    private final ExactPosition[] playersAlly = new ExactPosition[11];      // array of players played by the player
    private final ExactPosition[] playersAdversary = new ExactPosition[11];  // array of players played by the computer
     ...
     *
     * @param index the index of the player (player with the lowest back number
