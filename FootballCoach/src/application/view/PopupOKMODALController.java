 ...
 * @author Jochem
 */
public class PopupOKMODALController implements PopupControllerInterface {
    ...
    public void setModalValues(String titlevalue, String warningvalue, String messagevalue) {
        ...
        symbol.setImage(new Image(Main.class.getResourceAsStream("img/info.png")));
    ...
    /**
     * This method is triggered when the Cancel button is clicked (event handler
     * assigned in the .fxml) and it will close the popup
     */
    @FXML
